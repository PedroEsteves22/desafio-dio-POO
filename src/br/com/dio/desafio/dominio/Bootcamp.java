...
public class Bootcamp {
    ...
    private final LocalDate dataFinal = dataInicio.plusDays(45);//adiciona 45 dias a data inicial
    private Set<Dev> devsInscritos = new HashSet<>();
    private Set<Conteudo> conteudos = new LinkedHashSet<>();//ao adicionar mantem a ordem que foi adicionado
